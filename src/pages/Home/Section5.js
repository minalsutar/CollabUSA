    ...
    <section className='shop_section'>
        <Container>
            <Row className='align-items-center'>
                ...
                <Link to='/' >
                    <img src={StoreIos} alt="ios" className='img-fluid store m-3'/>
                </Link>
                <Link to='/' >
                    <img src={StoreGoogle} alt="Android" className='img-fluid store m-3'/>
                </Link>
                </Col>
                <Col lg={6}>
    ...
    <section className='brand_section'>
      ...
      <Carousel.Item>
        ...
        <div className='d-flex align-items-center justify-content-center'>
            ...
            <div className='brand-img'>
                <img src={Brand3} alt="brand-4" className='img-fluid'/>
            </div>
            <div className='brand-img'>
                <img src={Brand4} alt="brand-3" className='img-fluid'/>
            </div>
            <div className='brand-img'>
